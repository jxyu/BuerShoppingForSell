...
-(void)defaultSettings
{
    ...
    titleLabel.text = [_titlesList objectAtIndex:_defaultIndex][@"sp_name"];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    label.text = [_titlesList objectAtIndex:indexPath.row][@"sp_name"];
...
{
    titleLabel.text = [_titlesList objectAtIndex:indexPath.row][@"sp_name"];
    _isOpen = YES;
    [self tapAction];
